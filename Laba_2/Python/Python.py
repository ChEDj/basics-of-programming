...
if a <= 0 or b <= 0 or c <= 0 or a >= b + c or b >= a + c or c >= a + b:
    ...
    if a == b and a == c:
        ...
        if a > b and a > c:
            tr_sides = versatile_triangle(a, b, c)[0]
            tr_angles = versatile_triangle(a, b, c)[1]
        elif b > a and b > c:
            tr_sides = versatile_triangle(b, a, c)[0]
            tr_angles = versatile_triangle(b, a, c)[1]
        else:
            tr_sides = versatile_triangle(c, b, a)[0]
            tr_angles = versatile_triangle(c, b, a)[1]
