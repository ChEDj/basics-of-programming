...
string equilateral_triangle(float x, float y, float z, string& sides, string& angles) {
...
int main(){
	...
	if (a <= 0 || b <= 0 || c <= 0  || a >= b + c || b >= a + c || c >= a + b) {
		...
		if (a == b && b == c) {
			...
			if (a > b && a > c) {
				equilateral_triangle(a, b, c, tr_sides, tr_angles);
			}
			else if (b > a && b > c) {
				equilateral_triangle(b, a, c, tr_sides, tr_angles);
			}
			else if (c > b && c > a) {
				equilateral_triangle(c, a, b, tr_sides, tr_angles);
			}
		}
